 ...
 ** @brief The class stores information about particle masses and expected width
 *of the peacks.
 ** @author  M.Zyzak, I.Kisel
 ** @date 05.02.2019
 ** @version 1.0
 **
 ** The class contains information required for the reconstruction of decay
 *trees: \n
 ** - masses of the stable particles; \n
 ** - masses of the intermediate daughter particles (like Lambda, K0, Xi, D0,
 *etc.);\n
...
public:
  ...
  void GetMotherMass(const int32_v &pdg, float32_v &massMotherPDG,
     ...
     ** \param[out] massMotherPDGSigma - expected width of the corresponding
     *peak
     **/
...
private:
  ...
  /** Table PDG masses of short-lived particles, which are used for
   *reconstruction of the decay trees: \n
   ** [ 0] - K0s; \n [ 1] - Lambda; \n [ 2] - Xi; \n [ 3] - gamma; \n [ 4] -
   *Omega; \n [ 5] - H3Lambda; \n [ 6] - He4Lambda; \n [ 7] - He5Lambda. */
  float fMassSecPDG[8];
  /** Expected widths of peaks of short-lived particles, which are used for
   *reconstruction of the decay trees: \n
   ** [ 0] - K0s; \n [ 1] - Lambda; \n [ 2] - Xi; \n [ 3] - gamma; \n [ 4] -
   *Omega; \n [ 5] - H3Lambda; \n [ 6] - He4Lambda; \n [ 7] - He5Lambda. */
