 ...
 ** @version 1.0
 **
 ** The structure is used in the KFParticleTopoReconstructor::SortTracks()
 *function.
 ** Tracks are sorted according to their pdg hypothesis: electrons, muons,
 *pions,
...
/** @class KFPInputData
 ** @brief Class with the input data for KF Particle Finder: tracks, primary
 *vertex and magnetic field.
 ** @author  M.Zyzak, I.Kisel
 ** @date 05.02.2019
 ** @version 1.0
 **
 ** The class is used to transfer the data between devices: CPU and Intel Xeon
 *Phi. The memory is aligned
 ...
 ** @version 1.0
 **
 ** The structure contains pointer to array of KFPInputData objects. Copying of
 *the
 ...
 ** The structure contains pointer to array of KFPInputData objects. Copying of
 *the
 ** objects of this structure is disabled. The list is used to create a queue
 *for processing
