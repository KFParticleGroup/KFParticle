...
namespace KFPMath
{
  ...
  static inline __attribute__((always_inline)) float32_v log(const float32_v x) { return x; }

  static inline __attribute__((always_inline)) float32_v acos(const float32_v x) { return x; }
