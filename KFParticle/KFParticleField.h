 ...
 ** @brief A class to store a vector with the magnetic field values {Bx, By, Bz}
 *at the certain point.
 ** @author  M.Zyzak, I.Kisel
 ** @date 05.02.2019
 ** @version 1.0
 **
 ** The class is used to represent the vector of the magnetic field at the
 *certain position of the track.
 ** It contains three components of the magnetic field: Bx, By and Bz. It allows
 *to combine the current
...
public:
  ...
  void Combine(KFParticleFieldValue &B, float32_v w) {
     ...
     *another measurement
     ** weighted by "w"
     ** \param[in] B - another field measurement to be combined with the current
     *value
 ...
 ** @brief A class to store an approximation of the magnetic field along the
 *particle trajectory. Is used for nonhomogeneous field.
 ** @author  M.Zyzak, I.Kisel
 ** @date 05.02.2019
 ** @version 1.0
 **
 ** The class is used to store the approximation of the magnetic field along the
 *particle trajectory.
 ** Each component Bx, By, Bz is approximated with a parabola function depending
 *on the z coordinate.
