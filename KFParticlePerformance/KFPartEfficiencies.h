...
class KFEfficiencyParticleInfo {
 public:
  ...
  KFEfficiencyParticleInfo(std::string name, std::string title, int pdg, float histoMin, float histoMax, float mass,
...
class KFPartEfficiencies : public TObject {
 public:
    ...
    , clone()
  {
    ...
    //                       min   max    mass       lifetime    Q
      ...
      KFEfficiencyParticleInfo("K*-_K-,pi0", "K*-_K-pi0     ", -100323, 0.6f, 2.6f, 0.89166, 1.30e-23, -1,
                               0.0030),                                                                           // 19
      ...
      KFEfficiencyParticleInfo("K-_{3pi}", "K+3pi         ", -100321, 0.0f, 1.0f, 0.493677, 1.238e-8, -1,
                               0.0030),                                                                            // 45
      KFEfficiencyParticleInfo("K+_{3piK}", "K+3piK        ", 200321, 0.0f, 1.0f, 0.493677, 1.238e-8, 1, 0.0030),  // 46
      KFEfficiencyParticleInfo("K-_{3piK}", "K+3piK        ", -200321, 0.0f, 1.0f, 0.493677, 1.238e-8, -1,
                               0.0030),  // 47
      ...
      KFEfficiencyParticleInfo("D-_K0pi-", "D-_K0pi-      ", -100411, 0.6f, 4.6f, 1.86962, 1.04e-13, -1,
                               0.0030),                                                                          // 112
      KFEfficiencyParticleInfo("D+_K03pi", "D+_K03pi      ", 200411, 0.6f, 4.6f, 1.86962, 1.04e-13, 1, 0.0030),  // 113
      KFEfficiencyParticleInfo("D-_K03pi", "D-_K03pi      ", -200411, 0.6f, 4.6f, 1.86962, 1.04e-13, -1,
                               0.0030),                                                                           // 114
      ...
      KFEfficiencyParticleInfo("Ds+_K0K0pi+", "Ds+_K0K0pi+   ", 200431, 1.0f, 3.0f, 1.96850, 5.0e-13, 1,
                               0.0030),  // 121
      KFEfficiencyParticleInfo("Ds-_K0K0pi-", "Ds-_K0K0pi-   ", -200431, 1.0f, 3.0f, 1.96850, 5.0e-13, -1,
                               0.0030),  // 122
      KFEfficiencyParticleInfo("Ds+_K0K+pipi", "Ds+_K0K+pipi  ", 300431, 1.0f, 3.0f, 1.96850, 5.0e-13, 1,
                               0.0030),  // 123
      KFEfficiencyParticleInfo("Ds-_K0K-pipi", "Ds-_K0K-pipi  ", -300431, 1.0f, 3.0f, 1.96850, 5.0e-13, -1,
                               0.0030),                                                                           // 124
      KFEfficiencyParticleInfo("Ds+_K+pipi", "Ds+_K+pipi    ", 400431, 1.0f, 3.0f, 1.96850, 5.0e-13, 1, 0.0030),  // 125
      KFEfficiencyParticleInfo("Ds-_K-pipi", "Ds-_K-pipi    ", -400431, 1.0f, 3.0f, 1.96850, 5.0e-13, -1,
                               0.0030),                                                                         // 126
      ...
      KFEfficiencyParticleInfo("Lcb_{pK0}", "Lc b {pK0}    ", -104122, 1.8f, 3.8f, 2.28646, 2.0e-13, -1,
                               0.0030),  // 130
      KFEfficiencyParticleInfo("Lc_{pK02pi}", "Lc   {pK02pi} ", 204122, 1.8f, 3.8f, 2.28646, 2.0e-13, 1,
                               0.0030),  // 131
      KFEfficiencyParticleInfo("Lcb_{pK02pi}", "Lc b {pK02pi} ", -204122, 1.8f, 3.8f, 2.28646, 2.0e-13, -1,
                               0.0030),                                                                         // 132
      KFEfficiencyParticleInfo("Lc_{Lpi}", "Lc   {Lpi}    ", 304122, 1.8f, 3.8f, 2.28646, 2.0e-13, 1, 0.0030),  // 133
      KFEfficiencyParticleInfo("Lcb_{Lpi}", "Lc b {Lpi}    ", -304122, 1.8f, 3.8f, 2.28646, 2.0e-13, -1,
                               0.0030),                                                                          // 134
      KFEfficiencyParticleInfo("Lc_{L3pi}", "Lc   {L3pi}   ", 404122, 1.8f, 3.8f, 2.28646, 2.0e-13, 1, 0.0030),  // 135
      KFEfficiencyParticleInfo("Lcb_{L3pi}", "Lc b {L3pi}   ", -404122, 1.8f, 3.8f, 2.28646, 2.0e-13, -1,
                               0.0030),                                                                          // 136
      KFEfficiencyParticleInfo("Lc_{p2pi}", "Lc   {p2pi}   ", 504122, 1.8f, 3.8f, 2.28646, 2.0e-13, 1, 0.0030),  // 137
      KFEfficiencyParticleInfo("Lcb_{p2pi}", "Lc b {p2pi}   ", -504122, 1.8f, 3.8f, 2.28646, 2.0e-13, -1,
                               0.0030),                                                                        // 138
      ...
      KFEfficiencyParticleInfo("H3L_{dppi}b", "H3L_{dppi} b  ", -3012, 2.0f, 4.0f, 2.9908, 2.632e-10, -1,
                               0.0025),                                                                          // 166
      ...
      KFEfficiencyParticleInfo("H4L_{tppi}b", "H4L_{tppi} b  ", -3013, 3.0f, 5.0f, 3.9224, 2.632e-10, -1,
                               0.0025),                                                                          // 170
      KFEfficiencyParticleInfo("H4L_{ddpi}", "H4L_{ddpi}    ", 3014, 3.0f, 5.0f, 3.9224, 2.632e-10, 1, 0.0025),  // 171
      KFEfficiencyParticleInfo("H4L_{ddpi}b", "H4L_{ddpi} b  ", -3014, 3.0f, 5.0f, 3.9224, 2.632e-10, -1,
                               0.0025),                                                                         // 172
      KFEfficiencyParticleInfo("H5L_{tdpi}", "H5L_{tdpi}    ", 3015, 4.0f, 6.0f, 4.845, 2.632e-10, 1, 0.0030),  // 173
      KFEfficiencyParticleInfo("H5L_{tdpi}b", "H5L_{tdpi} b  ", -3015, 4.0f, 6.0f, 4.845, 2.632e-10, -1,
                               0.0030),                                                                          // 174
      KFEfficiencyParticleInfo("H6L_{He6pi}", "H6L_{He6pi}   ", 3016, 5.0f, 7.0f, 5.775, 2.632e-10, 1, 0.0030),  // 175
      KFEfficiencyParticleInfo("H6L_{He6pi}b", "H6L_{He6pi} b ", -3016, 5.0f, 7.0f, 5.775, 2.632e-10, -1,
                               0.0030),                                                                         // 176
      KFEfficiencyParticleInfo("H6L_{ttpi}", "H6L_{ttpi}    ", 3017, 5.0f, 7.0f, 5.775, 2.632e-10, 1, 0.0030),  // 177
      KFEfficiencyParticleInfo("H6L_{ttpi}b", "H6L_{ttpi} b  ", -3017, 5.0f, 7.0f, 5.775, 2.632e-10, -1,
                               0.0030),                                                                       // 178
      ...
      KFEfficiencyParticleInfo("He5L_{He3dpi}", "He5L_{He3dpi} ", 3018, 4.0f, 6.0f, 4.8393, 2.632e-10, 2,
                               0.0025),  // 183
      KFEfficiencyParticleInfo("He5L_{He3dpi}b", "He5L_{He3dpi}b", -3018, 4.0f, 6.0f, 4.8393, 2.632e-10, -2,
                               0.0025),                                                                          // 184
      KFEfficiencyParticleInfo("He6L_{Li6pi}", "He6L_{Li6pi} ", 3019, 5.0f, 7.0f, 5.775, 2.632e-10, 2, 0.0030),  // 185
      KFEfficiencyParticleInfo("He6L_{Li6pi}b", "He6L_{Li6pi}b", -3019, 5.0f, 7.0f, 5.775, 2.632e-10, -2,
                               0.0030),  // 186
      KFEfficiencyParticleInfo("He6L_{He3tpi}", "He6L_{He3tpi} ", 3020, 5.0f, 7.0f, 5.775, 2.632e-10, 2,
                               0.0030),  // 187
      KFEfficiencyParticleInfo("He6L_{He3tpi}b", "He6L_{He3tpi}b", -3020, 5.0f, 7.0f, 5.775, 2.632e-10, -2,
                               0.0030),  // 188
      KFEfficiencyParticleInfo("He6L_{He4dpi}", "He6L_{He4dpi} ", 3021, 5.0f, 7.0f, 5.775, 2.632e-10, 2,
                               0.0030),  // 189
      KFEfficiencyParticleInfo("He6L_{He4dpi}b", "He6L_{He4dpi}b", -3021, 5.0f, 7.0f, 5.775, 2.632e-10, -2,
                               0.0030),                                                                          // 190
      KFEfficiencyParticleInfo("He7L_{Li7pi}", "He7L_{Li7pi} ", 3022, 6.0f, 8.0f, 6.717, 2.632e-10, 2, 0.0030),  // 191
      KFEfficiencyParticleInfo("He7L_{Li7pi}b", "He7L_{Li7pi}b", -3022, 6.0f, 8.0f, 6.717, 2.632e-10, -2,
                               0.0030),  // 192
      KFEfficiencyParticleInfo("He7L_{He4tpi}", "He7L_{He4tpi} ", 3023, 6.0f, 8.0f, 6.717, 2.632e-10, 2,
                               0.0030),  // 193
      KFEfficiencyParticleInfo("He7L_{He4tpi}b", "He7L_{He4tpi}b", -3023, 6.0f, 8.0f, 6.717, 2.632e-10, -2,
                               0.0030),                                                                           // 194
      KFEfficiencyParticleInfo("Li6L_{2He3pi}", "Li6L_{2He3pi} ", 3024, 5.0f, 7.0f, 5.77, 2.632e-10, 3, 0.0030),  // 195
      KFEfficiencyParticleInfo("Li6L_{2He3pi}b", "Li6L_{2He3pi}b", -3024, 5.0f, 7.0f, 5.77, 2.632e-10, -3,
                               0.0030),                                                                           // 196
      KFEfficiencyParticleInfo("Li7L_{Be7pi}", "Li7L_{Be7pi}  ", 3025, 6.0f, 8.0f, 6.711, 2.632e-10, 3, 0.0030),  // 197
      KFEfficiencyParticleInfo("Li7L_{Be7pi}b", "Li7L_{Be7pi} b", -3025, 6.0f, 8.0f, 6.711, 2.632e-10, -3,
                               0.0030),  // 198
      KFEfficiencyParticleInfo("Li7L_{He3He4pi}", "Li7L          ", 3026, 6.0f, 8.0f, 6.711, 2.632e-10, 3,
                               0.0025),  // 199
      KFEfficiencyParticleInfo("Li7L_{He3He4pi}b", "Li7L b        ", -3026, 6.0f, 8.0f, 6.711, 2.632e-10, -3,
                               0.0025),  // 200
      KFEfficiencyParticleInfo("Li8L_{2He4pi}", "Li8L_{2He4pi} ", 3027, 7.0f, 9.0f, 7.642, 2.632e-10, 3,
                               0.0025),  // 201
      KFEfficiencyParticleInfo("Li8L_{2He4pi}b", "Li8L_{2He4pi}b", -3027, 7.0f, 9.0f, 7.642, 2.632e-10, -3,
                               0.0025),                                                                     // 202
      ...
      KFEfficiencyParticleInfo("H4LL_{He4Lpi-}", "H4LL_{He4Lpi-}", 3008, 3.0f, 5.0f, 4.10791, 2.632e-10, 1,
                               0.0030),  // 205
      KFEfficiencyParticleInfo("H4LL_{H3Lppi-}", "H4LL_{H3Lppi-}", 3009, 3.0f, 5.0f, 4.10791, 2.632e-10, 1,
                               0.0030),  // 206
      KFEfficiencyParticleInfo("H5LL_{He5Lpi-}", "H5LL_{He5Lpi-}", 3010, 4.0f, 6.0f, 5.04748, 2.632e-10, 1,
                               0.0030),                                                                       // 207
      ...
      KFEfficiencyParticleInfo("He4L*_{HeL}", "He4L*_{HeL}   ", 1003006, 3.5f, 4.5f, 3.923, 1.55e-22, 2,
                               0.0030),  // 219
      KFEfficiencyParticleInfo("He4L*_{HeL}b", "He4L*_{HeL} b ", -1003006, 3.5f, 4.5f, 3.923, 1.55e-22, 2,
                               0.0030),  // 220
      KFEfficiencyParticleInfo("He4L*_{H3Lp}", "He4L*_{H3Lp}  ", 2003006, 3.5f, 4.5f, 3.923, 1.55e-22, 2,
                               0.0030),  // 221
      KFEfficiencyParticleInfo("He4L*_{H3Lp}b", "He4L*_{H3Lp} b", -2003006, 3.5f, 4.5f, 3.923, 1.55e-22, 2,
                               0.0030),  // 222
      KFEfficiencyParticleInfo("He5L*_{HeL}", "He5L*_{HeL}   ", 1003007, 4.5f, 5.5f, 4.842, 1.55e-22, 2,
                               0.0030),  // 223
      KFEfficiencyParticleInfo("He5L*_{HeL}b", "He5L*_{HeL} b ", -1003007, 4.5f, 5.5f, 4.842, 1.55e-22, 2,
                               0.0030),  // 224
      KFEfficiencyParticleInfo("He5L*_{H4Lp}", "He5L*_{H4Lp}  ", 2003007, 4.5f, 5.5f, 4.842, 1.55e-22, 2,
                               0.0030),  // 225
      KFEfficiencyParticleInfo("He5L*_{H4Lp}b", "He5L*_{H4Lp} b", -2003007, 4.5f, 5.5f, 4.842, 1.55e-22, 2,
                               0.0030),                                                                    // 226
      ...
      // missing mass method
      KFEfficiencyParticleInfo("pi-_{mu,nu}", "pi-_{mnu}     ", -7000211, 0.f, 1.0f, 0.139570, 2.6e-8, -1,
                               0.0030),                                                                      // 237
      ...
      KFEfficiencyParticleInfo("K-_{mu,nu}", "K-_{mnu}      ", -7000321, 0.f, 1.0f, 0.493677, 1.238e-8, -1,
                               0.0030),                                                                     // 241
      ...
      KFEfficiencyParticleInfo("Sigma-_{pi-,n}", "Sigma-_{pi-n} ", 7003112, 0.0f, 2.0f, 1.197449, 1.479e-10, -1,
                               0.0100),                                                                          // 245
      KFEfficiencyParticleInfo("n_{Sigma-}", "n_{Sigma-}    ", 7002112, 0.0f, 1.5f, 0.9395654, 880, 0, 0.0030),  // 246
      KFEfficiencyParticleInfo("Sigma+_{pi+n}b", "Sigma+{pi+n} b", -7003112, 0.0f, 2.0f, 1.197449, 1.479e-10, -1,
                               0.0030),  // 247
      KFEfficiencyParticleInfo("n_{Sigma+} b", "n_{Sigma+b} b ", -7002112, 0.0f, 1.5f, 0.9395654, 880, 0,
                               0.0030),  // 248
      KFEfficiencyParticleInfo("Sigma-_{pi-n}b", "Sigma+{pi-n} b", -7003222, 0.0f, 2.0f, 1.18937, 0.8018e-10, 1,
                               0.0030),  // 249
      KFEfficiencyParticleInfo("n_{Sigma-} b", "n_{Sigma-_b} b", -8002112, 0.0f, 1.5f, 0.9395654, 0.93956541, 0,
                               0.0030),  // 250
      KFEfficiencyParticleInfo("Sigma+_{pi+n}", "Sigma+_{pi+n} ", 7003222, 0.0f, 2.0f, 1.18937, 0.8018e-10, 1,
                               0.0100),                                                                          // 251
      KFEfficiencyParticleInfo("n_{Sigma+}", "n_{Sigma+}    ", 8002112, 0.0f, 1.5f, 0.9395654, 880, 0, 0.0030),  // 252
      KFEfficiencyParticleInfo("Xi-_{pi-L}", "Xi-_{pi-L}    ", 7003312, 0.0f, 2.0f, 1.32171, 1.639e-10, -1,
                               0.0030),  // 253
      KFEfficiencyParticleInfo("Lambda_{Xi-}", "Lambda_{Xi-}  ", 7003122, 0.0f, 2.0f, 1.115683, 2.632e-10, 0,
                               0.0030),  // 254
      KFEfficiencyParticleInfo("Xi+_{pi+L_b}", "Xi+_{pi+L_b}  ", -7003312, 0.0f, 2.0f, 1.32171, 1.639e-10, 1,
                               0.0030),  // 255
      KFEfficiencyParticleInfo("Lambda_{Xi+} b", "Lambda_{Xi+} b", -7003122, 0.0f, 2.0f, 1.115683, 2.632e-10, 0,
                               0.0030),  // 256
      KFEfficiencyParticleInfo("Omega-_{Xi-pi0}", "Omega-{pi-Xi0}", 7003334, 0.0f, 2.0f, 1.67245, 0.821e-10, -1,
                               0.0030),  // 257
      KFEfficiencyParticleInfo("Xi0_{Omega-}", "Xi0_{Omega-}  ", 7003322, 0.0f, 2.0f, 1.31486, 2.9e-10, 0,
                               0.0030),  // 258
      KFEfficiencyParticleInfo("Omega+_{Xi+pi0}", "Omega+_{Xipi0}", -7003334, 0.0f, 2.0f, 1.67245, 0.821e-10, 1,
                               0.0030),  // 259
      KFEfficiencyParticleInfo("Xi0_{Omega+} b", "Xi0_{Omega+} b", -7003322, 0.0f, 2.0f, 1.31486, 2.9e-10, 0,
                               0.0030),  // 260
      KFEfficiencyParticleInfo("K-_{pi-pi0}", "K-_{pi-pi0}   ", -9000321, 0.0f, 1.0f, 0.493677, 1.24e-8, -1,
                               0.0030),  // 261
      KFEfficiencyParticleInfo("pi0_{K-}", "pi0_{K-}      ", -9000111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 262
      KFEfficiencyParticleInfo("K+_{pi+pi0}", "K+_{pi+pi0}   ", 9000321, 0.0f, 1.0f, 0.493677, 1.24e-8, 1,
                               0.0030),  // 263
      KFEfficiencyParticleInfo("pi0_{K+}", "pi0_{K+}      ", 9000111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 264
      KFEfficiencyParticleInfo("Omega-{K-L}", "Omega-_{K-L}  ", 8003334, 0.0f, 2.0f, 1.67245, 0.821e-10, -1,
                               0.0030),  // 265
      KFEfficiencyParticleInfo("Lambda_{Omega-}", "Lambda_{O-}   ", 8003122, 0.0f, 2.0f, 1.115683, 2.632e-10, 0,
                               0.0030),  // 266
      KFEfficiencyParticleInfo("Omega+_{K+L_b}", "Omega+_{K+Lb} ", -8003334, 0.0f, 2.0f, 1.67245, 0.821e-10, 1,
                               0.0030),  // 267
      KFEfficiencyParticleInfo("Lamda_{Omega+} b", "Lambda_{O+} b ", -8003122, 0.0f, 2.0f, 1.115683, 2.632e-10, 0,
                               0.0030),  // 268
      KFEfficiencyParticleInfo("Sigma-{p_b pi0} b", "Sigma-{ppi0} b", -8003222, 0.0f, 2.0f, 1.18937, 0.8018e-10, 1,
                               0.0030),  // 269
      KFEfficiencyParticleInfo("pi0_{Sigma-b}", "pi0_{Sigma-_b}", -8000111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 270
      KFEfficiencyParticleInfo("Sigma+_{p pi0}", "Sigma+_{ppi0} ", 8003222, 0.0f, 2.0f, 1.18937, 0.8018e-10, 1,
                               0.0250),  // 271
      KFEfficiencyParticleInfo("pi0_{Sigma+}", "pi0_{Sigma+}  ", 8000111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 272
      KFEfficiencyParticleInfo("He3L_{He3pi0}", "He3L_{He3pi0} ", 7003029, 2.9f, 3.9f, 2.991, 2.632e-10, 2,
                               0.0020),  // 273
      KFEfficiencyParticleInfo("pi0_{He3L+}", "pi0_{He3L+}   ", 7700111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 274
      KFEfficiencyParticleInfo("He3L_{He3pi0} b", "He3L_{He3pi0}b", -7003029, 2.9f, 3.9f, 2.991, 2.632e-10, 2,
                               0.0020),  // 275
      KFEfficiencyParticleInfo("pi0_{He3L-}", "pi0_{He3L-}   ", -7700111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 276
      KFEfficiencyParticleInfo("He4L_{He4pi0}", "He4L_{He4pi0} ", 7003006, 3.8f, 4.8f, 3.921, 2.632e-10, 2,
                               0.0020),  // 277
      KFEfficiencyParticleInfo("pi0_{He4L+}", "pi0_{He4L+}   ", 7800111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 278
      KFEfficiencyParticleInfo("He4L_{He4pi0} b", "He4L_{He4pi0}b", -7003006, 3.8f, 4.8f, 3.921, 2.632e-10, 2,
                               0.0020),  // 279
      KFEfficiencyParticleInfo("pi0_{He4L-}", "pi0_{He4L-}   ", -7800111, 0.0f, 1.0f, 0.1349766, 8.52e-17, 0,
                               0.0030),  // 280
      // tracks
      ...
      KFEfficiencyParticleInfo("d+", "d+            ", 1000010020, 0.0f, 2.5f, 1.87561294257, 1.0e20, 1,
                               0.0030),  // 291
      KFEfficiencyParticleInfo("d-", "d-            ", -1000010020, 0.0f, 2.5f, 1.87561294257, 1.0e20, -1,
                               0.0030),  // 292
      KFEfficiencyParticleInfo("t+", "t+            ", 1000010030, 0.0f, 3.5f, 2.80892113298, 1.0e20, 1,
                               0.0030),  // 293
      KFEfficiencyParticleInfo("t-", "t-            ", -1000010030, 0.0f, 3.5f, 2.80892113298, 1.0e20, -1,
                               0.0030),  // 294
      KFEfficiencyParticleInfo("He3+", "He3+          ", 1000020030, 0.0f, 3.5f, 2.80839160743, 1.0e20, 2,
                               0.0030),  // 295
      KFEfficiencyParticleInfo("He3-", "He3-          ", -1000020030, 0.0f, 3.5f, 2.80839160743, 1.0e20, -2,
                               0.0030),  // 296
      KFEfficiencyParticleInfo("He4+", "He4+          ", 1000020040, 0.0f, 4.5f, 3.7273794066, 1.0e20, 2,
                               0.0030),  // 297
      KFEfficiencyParticleInfo("He4-", "He4-          ", -1000020040, 0.0f, 4.5f, 3.7273794066, 1.0e20, -2,
                               0.0030),                                                                          // 298
      KFEfficiencyParticleInfo("He6+", "He6+          ", 1000020060, 0.0f, 6.5f, 5.6055375, 1.0e20, 2, 0.0030),  // 299
      KFEfficiencyParticleInfo("He6-", "He6-          ", -1000020060, 0.0f, 6.5f, 5.6055375, 1.0e20, -2,
                               0.0030),                                                                          // 300
      ...
      KFEfficiencyParticleInfo("Li7-", "Li7-          ", -1000030070, 0.0f, 7.5f, 6.5338336, 1.0e20, -3,
                               0.0030),                                                                          // 304
      KFEfficiencyParticleInfo("Be7+", "Be7+          ", 1000040070, 0.0f, 7.5f, 6.5341844, 1.0e20, 4, 0.0030),  // 305
      KFEfficiencyParticleInfo("Be7-", "Be7-          ", -1000040070, 0.0f, 7.5f, 6.5341844, 1.0e20, -4,
                               0.0030),  // 306
    ...
    for (int i = 0; i < nParticles; i++) { mPartMaxMult[i] = 20; }
    ...
    for (int iP = 0; iP < nParticles; iP++) { fPdgToIndex[particleInfo[iP].PDG()] = iP; }
  }
  ...
  void PrintEff()
  {
    ...
    for (int iC = 0; iC < NCounters; iC++) {
      std::cout << names[iC] << "  : " << std::setw(10) << ratio_reco1.counters[iC] << "  / " << std::setw(10)
                << ratio_reco2.counters[iC] << "  / " << std::setw(10) << ratio_reco3.counters[iC] << "  / "
                ...
                << "  / " << std::setw(10) << ghost.counters[iC] << "  / " << std::setw(10) << bg.counters[iC] << "  / "
                << std::setw(10) << reco.counters[iC] << "  / " << std::setw(10) << clone.counters[iC] << "  | "
                << std::setw(10) << mc1.counters[iC] << "  | " << std::setw(10) << mc2.counters[iC] << "  | "
  ...
  { return ratio_reco1.counters[3 * iDecay]; }  ///< Returns efficiency in 4pi for decay "iDecay".
  float GetTotalKFPEfficiency(int iDecay)
  { return ratio_reco3.counters[3 * iDecay]; }  ///< Returns efficiency of KF Particle Finder method (cuts) for decay
  ///< "iDecay".
  ...
  { return partDaughterPdg[iParticle].size(); }  ///< Returns number of daughter particles for the decay with index
  ///< "iParticle".
  ...
  { return partMass[iParticle]; }  ///< Returns the table mass of the decay with index "iParticle".
  float GetMassSigma(int iParticle) const
  { return partMassSigma[iParticle]; }  ///< Returns expected width of the mass peak of the decay with index
  ///< "iParticle".
  ...
  static const int fFirstMissingMassParticleIndex =
    237;                                                 ///< Index of the first decay reconstructed by the missing mass
                                                         ///< method.
  static const int fLastMissingMassParticleIndex = 280;  ///< Index of the last decay reconstructed by the missing mass
                                                         ///< method.
  ...
  std::vector<std::vector<int>> partDaughterPdg;  ///< Array with vectors of daughter particles for each
                                                  ///< decay.
 ...
 private:
  ...
  KFMCCounter<double> ratio_reco2;  ///< Efficiency normalised on the particles with all
                                    ///< daughters reconstructable for all decays.
  KFMCCounter<double> ratio_reco3;  ///< Efficiency normalised on the particles with all
  ...
  KFMCCounter<double> ratio_ghost;  ///< Ratio of the ghost candidates to the total number of
                                    ///< candidates for all species.
  KFMCCounter<double> ratio_bg;     ///< Ratio of the physics background candidates to the total
                                    ///< number of candidates for all species.
  KFMCCounter<double> ratio_clone;  ///< Ratio of double reconstructed particles to the total
