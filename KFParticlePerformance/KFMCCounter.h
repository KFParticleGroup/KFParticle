...
template <typename T> struct KFMCCounter {
  ...
  KFMCCounter(int nCounters)
      : NCounters(nCounters), counters(nCounters, T(0)) {
  ...
  KFMCCounter &operator+=(KFMCCounter &a) {
    if (NCounters != a.NCounters) {
      std::cout
          << " KFMCCounter: Error. Addition of counters of different sizes: "
   ...
   * object. */
  template <typename T2> KFMCCounter<double> operator/(KFMCCounter<T2> &a) {
  ...
  template <typename T2> KFMCCounter<T2> operator/(double a) {
