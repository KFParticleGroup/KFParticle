 ...
 ** @version 1.0
 **
 ** The class contains a set of histograms, allocates memory for them, sets
 *names and axis names.
...
public:
  ...
  /** Switch off collection of histograms for primary and secondary candidates.
   *Not to allocate memory should be called
   ** before KFParticlePerformanceBase::CreateHistos(). **/
  void DoNotStorePrimSecHistograms() { fStorePrimSecHistograms = 0; }
  /** Switch off collection of Z-R histograms. Not to allocate memory should be
   *called
   ** before KFParticlePerformanceBase::CreateHistos(). **/
 ...
 ** dX, dY, dZ, dPx, dPy, dPz, dE, dM **/
  ...
  static const int nHistoPartParam = 26;
#endif
  /** Number of sets of histograms with parameter distributions: 0 - all
   *candidates, 1 - reconstructed signal, 2 - physics background from other
   *decays, 3 - combinatorial
