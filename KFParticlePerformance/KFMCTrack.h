...
class KFMCTrack {
 public:
  ...
  float P() const
  { return sqrt(fPar[3] * fPar[3] + fPar[4] * fPar[4] + fPar[5] * fPar[5]); }  ///< Returns momentum of the track.
  float Pt() const
  ...
  { return fIsReconstructed; }  ///< Returns a flag showing if track was found by the reconstruction
  ///< procedure.
 ...
 protected:
  ...
  bool fIsOutOfDetector;  ///< A flag showing if track was out of acceptance. Is
