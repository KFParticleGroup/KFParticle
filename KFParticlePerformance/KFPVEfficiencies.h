 ...
 ** Definitions:\n
 ** background - physics background, when daughter particle come from the
 *secondary vertex;\n
 ** ghost - combinatorial background, tracks do not form a real vertex;\n
 ** clone - a vertex is reconstructed several times, for example, half of tracks
 *form one group and
...
public:
  KFPVEfficiencies()
      : names(), indices(), ratio_reco(), mc(), reco(), ratio_ghost(),
        ratio_bg(), ratio_clone(), ghost(), bg(), clone() {
  ...
  void Inc(bool isReco, int nClones, TString name) {
     ...
     ** \param[in] nClones - number of double reconstructed vertices for the
     *given MC vertex,
...
private:
  ...
  KFMCCounter<double> ratio_ghost; ///< Ratio of the ghost candidates to the
                                   ///< total number of candidates.
  KFMCCounter<double> ratio_bg; ///< Ratio of the physics background candidates
                                ///< to the total number of candidates.
  KFMCCounter<double>
      ratio_clone; ///< Ratio of double reconstructed vertices to the total
