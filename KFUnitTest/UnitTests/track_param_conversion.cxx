...
void PrintLocalParams(double x, double alpha, double params[5], double cv[15], short sign)
{
  ...
  std::cout << "parameters:\t" << params[0] << "\t" << params[1] << "\t" << params[2] << "\t" << params[3] << "\t"
            << params[4] << std::endl;
  std::cout << "sign:\t" << sign << std::endl;
  std::cout << "covmat:\t" << "\n"
            << cv[0] << "\n"
...
void track_param_conversion()
{
  ...
  double cv[21] = {31.0647,    -7.76618, 1.94154,    0.107363,  -0.0268407, 1.04271,    0.215503,
                   -0.0538757, 0.148689, 18.0375,    1.43335,   -0.358338,  0.00860631, 1.71594,
                   14.1278,    0.205969, -0.0514922, 0.0170188, 0.391058,   0.179991,   2.67912};
  //CreateCovMat(cv);
